...
https://www.overleaf.com/project/640d0e27d59da61b2bedf2ab
%%-------------------------------------
...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            \linespread{1.2}\huge {
                ...
                Learning Preference Elicitation Strategy in Conversational Recommender Systems
            ...
            {\large 
                ...
                \emph{Supervisor:} Dr Muhammad Shahzad}\\[1cm] % if applicable
            
    		% PLEASE DO NOT CHANGE THIS TEXT %
            \large A report submitted in partial fulfilment of the requirements of\\the University of Reading for the PhD Confirmation of Registration in \textit{Computer Science}\\[0.3cm] 
            \vfill
    ...
    I,
    %%%%%%%%%%%%%%%%%%%%%%%
     Aleksandra Makarova, % Mandatory part
    %%%%%%%%%%%%%%%%%%%%%%%
	...
	Aleksandra Makarova % Please change it to your name
    ...
    \input{chapters/background.tex}% https://guides.library.bloomu.edu/litreview
    \input{chapters/reinforcement_learning.tex}
    \input{chapters/recommendation_module.tex}
    \input{chapters/bot_play.tex}
    ...
    \bibliography{references,references_casper}  %  Patashnik, O. (1988), BibTEXing. Documentation for general BibTEX users.
