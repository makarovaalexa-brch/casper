...
print("\n=== E12 POST-INIT (residual=0 -> MUST == popularity) ===",flush=True); run('popularity',pick_pop); run('CASPER-init',pick_actor)
# ---- RLOO finetune ----
val_cases=[]
for cu in warm_val:
    rd=rb[cu]; items=list(rd.keys())
...
print("\n=== E12 FINAL NDCG (popularity-base + residual RL) ===",flush=True); run('popularity',pick_pop); run('CASPER-E12',pick_actor)
