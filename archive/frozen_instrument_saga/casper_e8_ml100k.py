...
print("\n=== E8 POST-BC (before RL) ===",flush=True); run('popularity',pick_pop); run('CASPER-BC(oracle)',pick_actor)
# ---- RLOO finetune ----
...
actor.eval()
print("\n=== E8 FINAL (BC+RL) ===",flush=True); run('popularity',pick_pop); run('CASPER-E8',pick_actor)
