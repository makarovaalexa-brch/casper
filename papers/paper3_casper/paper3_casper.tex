...
\title{\textbf{CASPER-C: \underline{C}ontinuous-Action Preference Elicitation by \underline{R}econstruction}\\[4pt]
\large Paper C (method) --- working draft, long/thesis format}
\author{}
\date{June 2026}
\begin{document}
\maketitle
...
Table~\ref{tab:ladder} supports three claims.
...
(\S\ref{sec:future}) must stress-test; and (iv) on a single dataset (ML-1M) and a frozen recommender. The pair-native
