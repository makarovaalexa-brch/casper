...
% TABLE PLACEHOLDER: ranked feature-importance table + explained-variance decomposition per channel
% (from D-ANS iteration-2; runs as of 2026-07-09). Also: the era-pocket case study (user 62120).
\textbf{[Placeholder: iteration-2 importance table, per-channel explained-vs-residual decomposition, era-pocket check.]}
