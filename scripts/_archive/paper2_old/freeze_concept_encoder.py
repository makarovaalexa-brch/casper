...
torch.save(enc.state_dict(), f'{base}/.cache/enc_concept.pt'); np.save(f'{base}/.cache/Ql_concept.npy', Qp.detach().numpy()); np.save(f'{base}/.cache/Ec_concept.npy', Ec.detach().numpy())
