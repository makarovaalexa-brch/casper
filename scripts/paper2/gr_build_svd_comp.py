"""
Goodreads COMPOSITE: biased-SVD item factors (linear reference). Reads base_comp.npz.
Same recipe as ML-1M/ML-25M/mystery: D=64 LAMF=0.05 LR=0.01 EP=15. Saves Q_svd_comp.npy, bi_svd_comp.npy.
"""
...
np.save(f'{GR}/Q_svd_comp.npy',Q); np.save(f'{GR}/bi_svd_comp.npy',bi)
print(f"SAVED Q_svd_comp.npy bi_svd_comp.npy ({time.time()-t0:.0f}s)",flush=True)
