...
of \S\ref{sec:future})---not user-memory slippage over which favourite to name. This robustness is corroborated on the
answer-noise axis by Paper~C's P4c ablation: under an answer channel fitted on real ML-1M ratings, real-rating item
answers are the \emph{most noise-robust} channel ($0.394$--$0.463$, versus a continuous latent probe that collapses to
$0.150$), reinforcing named/volunteered items as the deployment backbone of cold-start elicitation.
