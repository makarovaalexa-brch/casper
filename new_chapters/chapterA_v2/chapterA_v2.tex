...
($x\ge4$ and full-profile at the frontier bar), still \TODO{}. The measured points descend from left to right: accuracy
peaks at the item-only accuracy corner ($x{=}2.5$: RecVAE/EASE/EDLAE) and falls as interview-compatibility rises, with
the highest-compatibility measured core (belief-MF at $x{=}3.0$) sitting near the bottom of the accuracy column. The
