...
\begin{figure}[t]
  ...
  \caption{\textbf{Graded input helps over binarized input, most on the short interview (provisional; frozen
    ...
    fair positive-only baseline, the graded premium is \emph{CI-clean positive on the short interview}---$+0.012$
    at $k{=}2$ (CI $[+0.010,+0.014]$), $+0.007$ at $k{=}4$---and fades to a tie by $k{=}8$ as collaborative
    signal fills in: the extra bits a star carries are most decisive when few items are known. The
    ...
    pre-certification snapshot of the tower architecture; \REDO{graded-vs-binarized curve on the certified tower}}
