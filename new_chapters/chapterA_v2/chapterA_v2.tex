...
pending); \emph{recorded}$^{\dagger}$ (carried from record, re-certification pending---the $d512$ weights are off
disk and the pbC forward pass predates a refactor, \S\ref{sec:expdesign}); or ``---'' with a one-word reason
